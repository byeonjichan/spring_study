...
public class AccountMailService {
    ...
    public boolean sendAuthMail() {
        ...
        try {
            ...
            mailContent.append("<h3>해당 계정을 인증하기 위해 아래의 버튼을 클랙해 주세요</h3>");
    ...
    public Map<String , Object> authenticate(String token) {
        ...
        Map<String , Object > resultMap = null;
            ...
            //IllegalArgumentException => null 또는 반값
        try {
            claims = jwtProvider.getClaims(token);
            int userId = Integer.parseInt(claims.get("userId").toString());
            RoleRegister roleRegister = userMapper.findRoleRegistersByUserIdAndRoleId(userId, 2);
